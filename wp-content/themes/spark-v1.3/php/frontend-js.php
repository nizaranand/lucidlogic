...
if (!function_exists('spark_output_js')) {
	function spark_output_js() {
		...
		if ($spark_options['spark_performance_mode'] == "Speed") {
			...
			echo '<script src="'.get_template_directory_uri().'/static-server/min-merge-cache.php?format=js&files=jquery.flexslider-v1.8.min.js,jquery.ba-hashchange-v1.3.min.js,main-r9.js"></script>';
		} else {
