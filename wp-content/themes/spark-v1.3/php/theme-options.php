...
if (($pagenow == 'admin.php' || $pagenow == 'themes.php') && (isset($_GET['page']) && $_GET['page'] == 'option_tree')) { // Only in the "Theme Options" page
...
if (!function_exists('spark_admin_css')) {
	function spark_admin_css() {
		...
		echo '<style>
				...
				#framework_wrap #content_wrap .option-textblock textarea {
					width: 99%;
					height: 150px;
					font-family:courier, "courier new", monospace;
					line-height: 20px;
				}
				#framework_wrap #content_wrap .option-textblock textarea.bigger {
					height: 250px;
				}
				#framework_wrap #content_wrap #option_spark_shortcodes_heading .option-textblock h3 {
					padding-top: 35px;
				}
