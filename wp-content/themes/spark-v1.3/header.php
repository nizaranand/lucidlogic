...
$is_landing_page_class = (is_home() || is_front_page()) ? 'landing-page' : '';
...
<head>
	...
	<meta name="keywords" content="<?php echo $spark_options['spark_meta_keywords']; ?>">
	...
	<style>
	/* Custom CSS */
	<?php echo $spark_options['spark_custom_css']; ?>
	
	<?php if (is_array($spark_options['spark_page_bg']) && 
			  (  !empty($spark_options['spark_page_bg']['background-image'])
			  || !empty($spark_options['spark_page_bg']['background-color']) )) : ?>
	html, body, .dark, header, .dark header {
		background: <?php echo $spark_options['spark_page_bg']['background-color'].' url("'.$spark_options['spark_page_bg']['background-image']; ?>");
		background-repeat: <?php echo $spark_options['spark_page_bg']['background-repeat']; ?>;
		background-attachment: <?php echo $spark_options['spark_page_bg']['background-attachment']; ?>;
		background-position: <?php echo $spark_options['spark_page_bg']['background-position']; ?>;
	}
	<?php endif; ?>
	
	<?php if (is_array($spark_options['spark_header_bg']) && 
			  (  !empty($spark_options['spark_header_bg']['background-image'])
			  || !empty($spark_options['spark_header_bg']['background-color']) )) : ?>
	header, .dark header {
		background: <?php echo $spark_options['spark_header_bg']['background-color'].' url("'.$spark_options['spark_header_bg']['background-image']; ?>");
		background-repeat: <?php echo $spark_options['spark_header_bg']['background-repeat']; ?>;
		background-attachment: <?php echo $spark_options['spark_header_bg']['background-attachment']; ?>;
		background-position: <?php echo $spark_options['spark_header_bg']['background-position']; ?>;
	}
	<?php endif; ?>
	
	<?php if (is_array($spark_options['spark_dark_bg']) && 
			  (  !empty($spark_options['spark_dark_bg']['background-image'])
			  || !empty($spark_options['spark_dark_bg']['background-color']) )) : ?>
	.dark, 
	...
	.dark .box.dark,
	.box.dark {
		background: <?php echo $spark_options['spark_dark_bg']['background-color'].' url("'.$spark_options['spark_dark_bg']['background-image']; ?>");
		background-repeat: <?php echo $spark_options['spark_dark_bg']['background-repeat']; ?>;
		background-attachment: <?php echo $spark_options['spark_dark_bg']['background-attachment']; ?>;
		background-position: <?php echo $spark_options['spark_dark_bg']['background-position']; ?>;
	}
	<?php endif; ?>
	</style>
...
<body <?php body_class($layout_color_class.' '.$is_landing_page_class); ?>>
