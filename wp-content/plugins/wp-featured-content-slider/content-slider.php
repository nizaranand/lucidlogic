...
<div id="featured_slider">
	...
	<ul id="slider">
		...
		<li><div class="content_left"><h2><?php the_title();?></h2><?php echo c_slider_cut_text(get_the_content(), $c_slider_limit, $c_slider_points);?></div><div class="img_right"><img src="<?php echo $c_slider_thumb;?>" class="featured" /></div></li>
